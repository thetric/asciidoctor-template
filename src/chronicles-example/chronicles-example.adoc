...
Come on, [#bier-central]_Bier Central_.
Did you have to ask?
...
The vial's label read '```This used to be *ITALIC MONOSPACE* - which does not exist in Fira Code - because some dumb fuck thought it was a good idea```'.
...
We already showed you an XML example in <<ravages>>, a language we often rant about over beers at <<bier-central,Bier Central>>.
